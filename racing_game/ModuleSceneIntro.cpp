...
void ModuleSceneIntro::CreateLinearCircuit(vec3 pos)
{
	...
	App->physics->AddBody(left_limit, this, false, 0);
	App->physics->AddBody(right_limit, this, false, 0);
}
...
{
	CreateLinearCircuit(vec3(7.5, 8, 104));
	...
	Cube roof2_limit1(55, 4, 3);
	roof2_limit1.color = White;
	roof2_limit1.SetPos(237, 22, 220);
	App->physics->AddBody(roof2_limit1, this, false, 0);

	Cube roof2_limit2(3, 4, 25);
	roof2_limit2.color = White;
	roof2_limit2.SetPos(264, 22, 209);
	App->physics->AddBody(roof2_limit2, this, false, 0);

	Cube roof2_limit3(3, 4, 25);
	roof2_limit3.color = White;
	roof2_limit3.SetPos(210, 22, 209);
	App->physics->AddBody(roof2_limit3, this, false, 0);

	Cube long_ramp_limit1(3, 4, 150);
	long_ramp_limit1.color = White;
	long_ramp_limit1.SetPos(235, 2, 125);
	long_ramp_limit1.SetRotation(-15, vec3(1, 0, 0));
	App->physics->AddBody(long_ramp_limit1, this, false, 0);

	Cube long_ramp_limit2(3, 4, 150);
	long_ramp_limit2.color = White;
	long_ramp_limit2.SetPos(210, 2, 125);
	long_ramp_limit2.SetRotation(-15, vec3(1, 0, 0));
	App->physics->AddBody(long_ramp_limit2, this, false, 0);

	Cube long_ramp_limit3(3, 4, 145);
	long_ramp_limit3.color = White;
	long_ramp_limit3.SetPos(242, 10, 125);
	long_ramp_limit3.SetRotation(-8, vec3(1, 0, 0));
	App->physics->AddBody(long_ramp_limit3, this, false, 0);

	Cube long_ramp_limit4(3, 4, 145);
	long_ramp_limit4.color = White;
	long_ramp_limit4.SetPos(263, 10, 125);
	long_ramp_limit4.SetRotation(-8, vec3(1, 0, 0));
	App->physics->AddBody(long_ramp_limit4, this, false, 0);
}
...
void ModuleSceneIntro::CreateColorRamps()
{
	...
	long_ramp_limit1.SetPos(235, 2, 125);
	long_ramp_limit1.SetRotation(-15, vec3(1, 0, 0));
	long_ramp_limit1.Render();

	Cube long_ramp_limit2(3, 4, 150);
	long_ramp_limit2.color = White;
	long_ramp_limit2.SetPos(210, 2, 125);
	long_ramp_limit2.SetRotation(-15, vec3(1, 0, 0));
	long_ramp_limit2.Render();

	Cube long_ramp_limit3(3, 4, 145);
	long_ramp_limit3.color = White;
	long_ramp_limit3.SetPos(242, 10, 125);
	long_ramp_limit3.SetRotation(-8, vec3(1, 0, 0));
	long_ramp_limit3.Render();

	Cube long_ramp_limit4(3, 4, 145);
	long_ramp_limit4.color = White;
	long_ramp_limit4.SetPos(263, 10, 125);
	long_ramp_limit4.SetRotation(-8, vec3(1, 0, 0));
	long_ramp_limit4.Render();
}